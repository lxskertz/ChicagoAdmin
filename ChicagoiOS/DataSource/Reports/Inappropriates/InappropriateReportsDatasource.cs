...
namespace TabsAdmin.Mobile.ChicagoiOS.DataSource.Reports.Inappropriates
{
    public class InappropriateReportsDatasource : UITableViewSource
    {
        ...
        /// 
        /// </summary>
        public List<InappropriateReport> CheckIns { get; set; }
        ...
        public InappropriateReportsDatasource(DailySpamReportsController controller, List<InappropriateReport> checkIns,
        ...
        public override UITableViewCell GetCell(UITableView tableView, NSIndexPath indexPath)
        {
            ...
            if (item != null)
            {
                ...
                var date = item.CheckInDate.HasValue ? item.CheckInDate.Value.ToString() : "";
                var reason = InappropriatePostHelper.GetReason(item.CheckInReportReason);
                ...
                cell.InappropriateReport = item;
                cell.InappropriateReportsDatasource = this;
